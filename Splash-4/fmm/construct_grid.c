...
#endif // WITH_NO_OPTIONAL_LOCKS
*/
				 box * gbc = LOAD(global_box->children[i]);
...
#endif // WITH_NO_OPTIONAL_LOCKS
*/
	    global_box = LOAD(global_parent->children[local_box->child_num]);
     }
      }
   }
}
...
#endif // WITH_NO_OPTIONAL_LOCKS
*/
        box * pbc = LOAD(pb->children[child->child_num]);
